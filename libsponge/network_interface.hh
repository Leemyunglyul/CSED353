...
class NetworkInterface {
  private:
    ...
    std::map<uint32_t, std::pair<EthernetAddress, size_t>> arp_cache{};
    std::map<uint32_t, size_t> arp_request_time{};

    std::queue<std::pair<InternetDatagram, uint32_t>> waiting_datagrams{};
